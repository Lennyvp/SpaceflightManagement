...
public class FlightForm extends FormLayout {
    ...
    private void bindBinderForFields() {
        ...
        binder.forField(countOfSeats)
                ...
                .bind(flight -> (double) flight.getCountOfSeats(),
                        (flight, Double) -> flight.setCountOfSeats(countOfSeats.getValue().intValue())
                );
        ...
        binder.forField(multiSelect)
                .bind(Flight::getTouristList, Flight::setTouristList);
...
//        });
    ...
    private void touristControllMethod() {
        touristList = touristService.findAllTourists();
