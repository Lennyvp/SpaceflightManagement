...
//                .asRequired("Choose At least 1")
                .bind(Tourist::getFlightList, Tourist::setFlightList);
...
//        });
    ...
    private void flightControllMethod() {
        flightList = flightService.findAllFlights();
